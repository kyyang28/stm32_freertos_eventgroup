...
#else
// utility macros to join/split priority
#define NVIC_PRIORITY_GROUPING 		NVIC_PriorityGroup_4                // For FreeRTOS
//#define NVIC_PRIORITY_GROUPING 		NVIC_PriorityGroup_2                // Should be compatible with FreeRTOS
...
/*
    NVIC_BUILD_PRIORITY(0, 0): 0x0
    NVIC_BUILD_PRIORITY(0, 1): 0x10
    NVIC_BUILD_PRIORITY(0, 2): 0x20
    NVIC_BUILD_PRIORITY(0, 3): 0x30
    NVIC_BUILD_PRIORITY(0, 4): 0x0
    NVIC_BUILD_PRIORITY(1, 0): 0x40
    NVIC_BUILD_PRIORITY(1, 1): 0x50
    NVIC_BUILD_PRIORITY(1, 2): 0x60
    NVIC_BUILD_PRIORITY(1, 3): 0x70
    NVIC_BUILD_PRIORITY(1, 4): 0x40
 */
...
#define NVIC_PRIO_WS2811_DMA               NVIC_BUILD_PRIORITY(1, 2)  // 0x60, TODO - is there some reason to use high priority? (or to use DMA IRQ at all?)
...
#define NVIC_PRIO_USRBTN_EXTI			   NVIC_BUILD_PRIORITY(1, 2)			// 0x60, user button
